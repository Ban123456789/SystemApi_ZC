...
namespace Accura_MES.Extensions
{
    public static class ServiceExtensions
    {
        ...
        public static async Task<ResponseObject> HandleExceptionAsync(
            this IService service, Exception exception, SqlTransaction? transaction = null)
        {
            ...
            catch (Exception ex)
            {
                responseObject.SetErrorCodeWithStackTrace(
                    SelfErrorCode.INTERNAL_SERVER_WITH_MSG, ex.ToString(), null, $"[Service 通用例外處理方法] 發生系統例外");
            ...
            switch (exception)
            {
                ...
                case CustomErrorCodeException customErrorCodeException:
                    ...
                    else
                    {
                        responseObject.SetErrorCodeWithStackTrace(
                            ...
                            customErrorCodeException.ToString(),
                            null,
                            $"[Service] 發生自訂例外: {customErrorCodeException.Message}");
                ...
                case SqlException sqlException:
                    ...
                    responseObject.SetErrorCodeWithStackTrace(
                        ...
                        sqlException,
                        $"[Service] 發生SQL例外: 友好訊息:[{friendlyMessage}]");
                    break;
                ...
                default:
                    responseObject.SetErrorCodeWithStackTrace(
                        ...
                        exception.ToString(),
                        null,
                        $"[Service] 發生系統例外: {exception.Message}");
                    break;
            }
        }
    }
