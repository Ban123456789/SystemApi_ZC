...
namespace Accura_MES.Controllers
{
    ...
    public class CustomerPriceController : ControllerBase
    {
        ...
        /// <param name="request">查詢請求</param>
        /// <returns></returns>
        [HttpPost("CustomerReceivables")]
        public async Task<IActionResult> CustomerReceivables([FromBody] CustomerReceivablesRequest request)
        {
            try
            {
                // 取得 connection
                ...
                // 取得客戶應收統計
                ResponseObject responseObject = await customerPriceService.CustomerReceivables(request);
